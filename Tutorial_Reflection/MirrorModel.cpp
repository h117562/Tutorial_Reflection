...
bool MirrorModel::Initialize(ID3D11Device* pDevice)
{
	...
	m_vertices[0].color = DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 0.0f);

	m_vertices[1].position = DirectX::XMFLOAT3(-1.0f, 1.0f, 0.0f);
	m_vertices[1].color = DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 0.0f);

	m_vertices[2].position = DirectX::XMFLOAT3(1.0f, -1.0f, 0.0f);
	m_vertices[2].color = DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 0.0f);

	m_vertices[3].position = DirectX::XMFLOAT3(1.0f, 1.0f, 0.0f);
	m_vertices[3].color = DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 0.0f);

	m_vertices[4].position = DirectX::XMFLOAT3(1.0f, -1.0f, 0.0f);
	m_vertices[4].color = DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 0.0f);

	m_vertices[5].position = DirectX::XMFLOAT3(-1.0f, 1.0f, 0.0f);
	m_vertices[5].color = DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 0.0f);
